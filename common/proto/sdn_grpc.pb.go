...
func (c *connectionManagerClient) SendFlowMod(ctx context.Context, in *FlowModRequest, opts ...grpc.CallOption) (*FlowModResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FlowModResponse)
	err := c.cc.Invoke(ctx, ConnectionManager_SendFlowMod_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterConnectionManagerServer(s grpc.ServiceRegistrar, srv ConnectionManagerServer) {
	// If the following call pancis, it indicates UnimplementedConnectionManagerServer was
...
func _ConnectionManager_SendFlowMod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FlowModRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConnectionManagerServer).SendFlowMod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConnectionManager_SendFlowMod_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConnectionManagerServer).SendFlowMod(ctx, req.(*FlowModRequest))
	}
...
var ConnectionManager_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sdn.ConnectionManager",
