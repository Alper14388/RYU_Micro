...
type FlowAddRequest struct {
	...
	Src           string                 `protobuf:"bytes,3,opt,name=src,proto3" json:"src,omitempty"` // Ethernet source address
	Dst           string                 `protobuf:"bytes,4,opt,name=dst,proto3" json:"dst,omitempty"` // Ethernet destination address
	...
	TableId       uint32                 `protobuf:"varint,10,opt,name=table_id,json=tableId,proto3" json:"table_id,omitempty"`          // Yeni eklendi
	Flags         uint32                 `protobuf:"varint,11,opt,name=flags,proto3" json:"flags,omitempty"`                             // Yeni eklendi
	Cookie        uint64                 `protobuf:"varint,12,opt,name=cookie,proto3" json:"cookie,omitempty"`                           // Yeni eklendi
	CookieMask    uint64                 `protobuf:"varint,13,opt,name=cookie_mask,json=cookieMask,proto3" json:"cookie_mask,omitempty"` // Yeni eklendi
...
type FlowModRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Data          []byte                 `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`                       // JSON encoded FlowMod data
...
type FlowModResponse struct {
	...
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	ErrorCode     uint32                 `protobuf:"varint,3,opt,name=error_code,json=errorCode,proto3" json:"error_code,omitempty"` // Yeni eklendi
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MatchField struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Class         uint32                 `protobuf:"varint,1,opt,name=class,proto3" json:"class,omitempty"` // OpenFlow match field class
	Field         uint32                 `protobuf:"varint,2,opt,name=field,proto3" json:"field,omitempty"` // Field type (in_port, eth_src, eth_dst vs.)
	Value         []byte                 `protobuf:"bytes,3,opt,name=value,proto3" json:"value,omitempty"`  // Field value
	Mask          []byte                 `protobuf:"bytes,4,opt,name=mask,proto3" json:"mask,omitempty"`    // Optional mask for the field
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Action struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          uint32                 `protobuf:"varint,1,opt,name=type,proto3" json:"type,omitempty"`                   // Action type (output, set_field vs.)
	Port          uint32                 `protobuf:"varint,2,opt,name=port,proto3" json:"port,omitempty"`                   // For output actions
	MaxLen        uint32                 `protobuf:"varint,3,opt,name=max_len,json=maxLen,proto3" json:"max_len,omitempty"` // For output actions
	Data          []byte                 `protobuf:"bytes,4,opt,name=data,proto3" json:"data,omitempty"`                    // Additional action data
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PacketOutRequest struct {
	...
	Data          []byte                 `protobuf:"bytes,4,opt,name=data,proto3" json:"data,omitempty"` // Raw packet data
	BufferId      uint32                 `protobuf:"varint,5,opt,name=buffer_id,json=bufferId,proto3" json:"buffer_id,omitempty"`
	Actions       []*Action              `protobuf:"bytes,6,rep,name=actions,proto3" json:"actions,omitempty"` // Yeni eklendi
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PacketOutRequest) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *PacketOutRequest) GetActions() []*Action {
	if x != nil {
		return x.Actions
	}
	return nil
...
func (x *PacketOutResponse) GetErrorCode() uint32 {
	if x != nil {
		return x.ErrorCode
	}
	return 0
...
type PacketInRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SwitchId      uint64                 `protobuf:"varint,1,opt,name=switch_id,json=switchId,proto3" json:"switch_id,omitempty"` // Switch ID (Datapath ID)
	...
	MatchFields   []*MatchField          `protobuf:"bytes,7,rep,name=match_fields,json=matchFields,proto3" json:"match_fields,omitempty"` // Changed to MatchField
	Data          []byte                 `protobuf:"bytes,8,opt,name=data,proto3" json:"data,omitempty"`                                  // Raw packet data
	TotalLen      uint32                 `protobuf:"varint,9,opt,name=total_len,json=totalLen,proto3" json:"total_len,omitempty"`         // New field
	InPort        uint32                 `protobuf:"varint,10,opt,name=in_port,json=inPort,proto3" json:"in_port,omitempty"`              // New field
	InPhyPort     uint32                 `protobuf:"varint,11,opt,name=in_phy_port,json=inPhyPort,proto3" json:"in_phy_port,omitempty"`   // New field
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_proto_sdn_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x64, 0x65, 0x22, 0xcc, 0x02, 0x0a, 0x0f, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x49, 0x6e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x77, 0x69, 0x74, 0x63,
	0x68, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x73, 0x77, 0x69, 0x74,
	0x63, 0x68, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x62, 0x75, 0x66, 0x66, 0x65, 0x72, 0x5f, 0x69,
	...
	,
	...
	,
...
var file_proto_sdn_proto_goTypes = []any{
	...
	(*PacketOutRequest)(nil),  // 7: sdn.PacketOutRequest
	(*PacketOutResponse)(nil), // 8: sdn.PacketOutResponse
